...
//			Map<String,UserAvatar> toAddUserAvatar = new HashMap<String, UserAvatar>();
		...
		public void onContactDeleted(final List<String> usernameList) {
			...
			List<String> toDeleteUsername = new ArrayList<String>();
			for (String username : usernameList) {
		...
		public void onContactInvited(String username, String reason) {
			Log.e(TAG,"onContactInvited,usernameList="+username+",reason="+reason);
		...
		public void onContactAgreed(String username) {
			Log.e(TAG,"onContactAgreed,usernameList="+username);
			List<InviteMessage> msgs = inviteMessgeDao.getMessagesList();
			for (InviteMessage inviteMessage : msgs) {
