...
//			uploadHeadPhoto();
			mOnSetAvatarListener = new OnSetAvatarListener(UserProfileActivity.this,R.id.layout_update_avatar,getAvatarName(),I.AVATAR_TYPE_USER_PATH);
			break;
	...
	private void uploadAvatar(final Intent data) {
